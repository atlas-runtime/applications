        ...
        if (Object.prototype.hasOwnProperty.call(modeGrid, key)) {
            ...
            if (Object.prototype.hasOwnProperty.                                      
                ...
                if (truename.includes("./lib/express") || truename.includes("name") ||
                    truename.includes("prototype") ||  
                    truename.includes("stream") || truename.includes("/route") ||     
                    truename.includes("websocket") || truename.includes("api/event") || 
                    truename.includes("iframe") || truename.includes('chunking') ||
                    truename.includes('trans'))
                    return;                                                             
